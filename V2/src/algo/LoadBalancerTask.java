...
public class LoadBalancerTask implements Runnable {
    ...
    final ConsistantHashing.HashFunction hashFunction;

    public LoadBalancerTask(final SortedMap<Integer, String> bucketIdToServer, final ConsistantHashing.HashFunction hashFunction) {
